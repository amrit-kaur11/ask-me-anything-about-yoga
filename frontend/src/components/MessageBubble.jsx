...
import remarkGfm from "remark-gfm";   // ← this is the missing piece
    ...
    <div style={{ marginTop: 18 }}>
      {isUnsafe && (
        <div style={{
          ...
          border: "1px solid #cc0000", background: "#ffe6e6", marginBottom: 14,
        }}>
            ...
            components={{
              ...
              th: ({ node, ...props }) => (
                <th style={{
                  ...
                  background: "#f3f4f6", textAlign: "left", fontWeight: 600,
                }} {...props} />
              ),
              td: ({ node, ...props }) => (
                <td style={{
